...
const { landCourtValiditorHandler } = require('../../middleware/validators');
const { multerInstance } = require('../../../helper/imageUpload')



const api_name = "/api/v1/land/court";
let validateErrors = null;

const courtSectionHandler = async (req, res) => {
  ...
  multerInstance(req, res, async (err) => {
    ...
    try {
      ...
      await landCourtValiditorHandler(req);
...
module.exports = { courtSectionHandler };